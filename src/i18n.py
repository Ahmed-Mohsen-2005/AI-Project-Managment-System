...
translations = {
    ...
    'fr': {
        ...
        'ai_governance': 'Gouvernance de l\'IA',
        
        # General Tab
        'general_app_settings': 'Paramètres Généraux de l\'Application',
        ...
        # Security Tab
        'security_role_mgmt': 'Sécurité et Gestion des Rôles (Admin Uniquement)',
        'authentication': 'Authentification',
        'two_factor_auth': 'Authentification à Deux Facteurs (2FA)',
        'rbac': 'Contrôle d\'Accès Basé sur les Rôles (FR-201)',
        'manage_user_permissions': 'Gérer les Permissions des Utilisateurs',
        'current_role': 'Rôle Actuel',
        'permission': 'Permission',
        'status': 'Statut',
        'manage_budget': 'Gérer le Budget (FR-403)',
        'create_projects': 'Créer des Projets (FR-101)',
        'save_permissions': 'Enregistrer les Permissions',
        
        # Integrations Tab
        'external_tools': 'Connexions d\'Outils Externes',
        'connected': 'Connecté',
        ...
        # AI Governance Tab
        'ai_model_governance': 'Modèle d\'IA et Gouvernance (FR-508)',
        'model_information': 'Informations du Modèle',
        'active_model_version': 'Version du Modèle Actif',
        'last_training_date': 'Date du Dernier Entraînement',
        'ai_feature_controls': 'Contrôles des Fonctionnalités d\'IA',
        'enable_predictive_risk': 'Activer les Scores de Risque Prédictif (FR-203)',
        'enable_sentiment_analysis': 'Activer l\'Analyse des Sentiments (FR-503)',
        'audit_compliance': 'Audit et Conformité (FR-508)',
        'ai_decisions_logged': 'Toutes les décisions d\'IA et les mises à jour du modèle sont enregistrées et traçables.',
        'export_audit_log': 'Exporter le Journal d\'Audit d\'IA',
        
        # Notifications Tab
        'notification_channels': 'Canaux de Notification',
        'email_preferences': 'Préférences Email',
        'receive_email_alerts': 'Recevoir les Alertes Email pour les Tâches P1',
        'slack_configuration': 'Configuration Slack (Lié via Intégration)',
        'alerts_sent_to': 'Les alertes sont actuellement envoyées à',
        'receive_swarm_alerts': 'Recevoir les Alertes pour l\'Attribution en Essaim (FR-202)',
